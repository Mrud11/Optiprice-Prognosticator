...
df = pd.read_excel(r'd:\Users\Mirdula\Desktop\Info-Spring\Final\Run\User interface with readme\ecommerce_price_predictor_combined_with_sales_discounted.xlsx')
